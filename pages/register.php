...
if($_POST['register'])
{
	...
	else
	{
		...
		$rUsers = Query("insert into {users} (id, name, password, primarygroup, regdate, lastactivity, lastip, email, sex, theme) values ({0}, {1}, {2}, {3}, {4}, {5}, {5}, {6}, {7}, {8})", 
			$uid, $_POST['name'], $_POST['pass'], Settings::get('defaultGroup'), time(), $_SERVER['REMOTE_ADDR'], $_POST['email'], (int)$_POST['sex'], Settings::get("defaultTheme"));
